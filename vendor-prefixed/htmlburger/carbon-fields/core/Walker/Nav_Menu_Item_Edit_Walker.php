...
namespace Whisk\Recipes\Vendor\Carbon_Fields\Walker;
 ...
 */
class Nav_Menu_Item_Edit_Walker extends \Whisk\Recipes\Vendor\Walker_Nav_Menu_Edit
{
    /**
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        // Build the regex
        $regex = \sprintf('~(?<!%s)(%s)~', \preg_quote($flag, '~'), \implode('|', $markers));
        // Injects the HTML
