 ...
 */
class Theme_Options_Datastore extends \Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Key_Value_Datastore
{
    /**
     ...
     */
    protected function get_storage_array(\Whisk\Recipes\Vendor\Carbon_Fields\Field\Field $field, $storage_key_patterns)
    {
        global $wpdb;
     ...
     * @param bool $autoload
     */
    protected function save_key_value_pair_with_autoload($key, $value, $autoload = \true)
    {
    ...
    {
        global $wpdb;
        $storage_key_patterns = $this->key_toolset->get_storage_key_deleter_patterns($field instanceof \Whisk\Recipes\Vendor\Carbon_Fields\Field\Complex_Field, $field->is_simple_root_field(), $this->get_full_hierarchy_for_field($field), $this->get_full_hierarchy_index_for_field($field));
        $storage_key_comparisons = $this->key_toolset->storage_key_patterns_to_sql('`option_name`', $storage_key_patterns);
