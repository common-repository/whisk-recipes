...
class User_Meta_Container extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Container
{
    protected $user_id;
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Datastore::make('user_meta'), $this->has_default_datastore());
        }
    ...
    protected function get_environment_for_request()
    {
        ...
        $environment = array('user_id' => $user ? \intval($user->ID) : 0, 'user' => $user ? $user : null, 'roles' => $user ? $user->roles : array());
        return $environment;
    }
    /**
    ...
    protected function get_environment_for_object($object_id)
    {
        ...
        $environment = array('user_id' => \intval($user->ID), 'user' => $user, 'roles' => $user->roles);
        return $environment;
    }
    /**
    ...
    public function render($user_profile = null)
    {
        ...
        include \Whisk\Recipes\Vendor\Carbon_Fields\DIR . '/templates/Container/user_meta.php';
    }
    /**
