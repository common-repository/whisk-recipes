...
class Block_Container extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Container
{
    /**
     * {@inheritDoc}
     */
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Datastore::make('empty'), $this->has_default_datastore());
        }
    }
    /**
     * {@inheritDoc}
    ...
    {
        return \function_exists('Whisk\\Recipes\\Vendor\\register_block_type');
    }
    /**
     * {@inheritDoc}
     */
    ...
    public function set_category($slug, $title = null, $icon = null)
    {
        ...
        $this->settings['category']['title'] = $title ?: \Whisk\Recipes\Vendor\Carbon_Fields\Helper\Helper::normalize_label($slug);
        return $this;
    }
    /**
    ...
    public function set_mode($mode)
    {
        ...
        if (!\in_array($mode, $modes)) {
            \Whisk\Recipes\Vendor\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('The mode must be one of the following: ' . \implode(', ', $modes));
        }
