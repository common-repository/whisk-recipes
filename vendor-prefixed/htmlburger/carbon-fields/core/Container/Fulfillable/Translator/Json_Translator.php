...
class Json_Translator extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Fulfillable\Translator\Array_Translator
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        if (empty($foreign)) {
            return array('relation' => 'AND', 'conditions' => array());
        }
        ...
        return array('relation' => $foreign['relation'], 'conditions' => $conditions);
    }
}
