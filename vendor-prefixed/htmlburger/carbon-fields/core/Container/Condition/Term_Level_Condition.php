 ...
 */
class Term_Level_Condition extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Condition\Condition
{
    /**
    ...
    public function is_fulfilled($environment)
    {
        ...
        return $this->compare($term_level, $this->get_comparison_operator(), $value);
    }
}
