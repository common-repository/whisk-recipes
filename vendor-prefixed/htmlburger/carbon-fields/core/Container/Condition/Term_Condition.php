 ...
 */
class Term_Condition extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Condition\Condition
{
    /**
    ...
    public function is_fulfilled($environment)
    {
        ...
        return $this->compare($term_id, $this->get_comparison_operator(), $this->get_value());
    }
}
