 ...
 */
class Term_Ancestor_Condition extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Condition\Term_Condition
{
    public function is_fulfilled($environment)
    {
        ...
        return $this->compare($ancestors, $this->get_comparison_operator(), $value);
    }
}
