 ...
 */
class Post_Level_Condition extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Condition\Condition
{
    /**
    ...
    public function is_fulfilled($environment)
    {
        ...
        return $this->compare($post_level, $this->get_comparison_operator(), $value);
    }
}
