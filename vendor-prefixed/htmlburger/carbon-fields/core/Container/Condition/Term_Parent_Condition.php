 ...
 */
class Term_Parent_Condition extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Condition\Term_Condition
{
    public function is_fulfilled($environment)
    {
        ...
        return $this->compare($parent_term_id, $this->get_comparison_operator(), $value);
    }
}
