 ...
 */
class Term_Meta_Container extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Container
{
    protected $term_id;
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Datastore::make('term_meta'), $this->has_default_datastore());
        }
    }
    /**
    ...
    protected function get_environment_for_request()
    {
        ...
        $environment = array('term_id' => $term ? \intval($term->term_id) : 0, 'term' => $term, 'taxonomy' => $term ? $term->taxonomy : $request_taxonomy);
        return $environment;
    }
    /**
    ...
    protected function get_environment_for_object($object_id)
    {
        ...
        $environment = array('term_id' => \intval($term->term_id), 'term' => $term, 'taxonomy' => $term->taxonomy);
        return $environment;
    }
    /**
    ...
    public function render($term = null)
    {
        ...
        include \Whisk\Recipes\Vendor\Carbon_Fields\DIR . '/templates/Container/term_meta.php';
    }
    /**
    ...
    public function get_taxonomy_visibility()
    {
        ...
        $evaluated_collection = $this->condition_collection->evaluate(array('term_taxonomy'), \true, array(), \true);
        $shown_on = array();
        foreach ($all_taxonomies as $taxonomy) {
            $environment = array('taxonomy' => $taxonomy);
