 ...
 */
class Post_Meta_Container extends \Whisk\Recipes\Vendor\Carbon_Fields\Container\Container
{
    /**
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Datastore::make('post_meta'), $this->has_default_datastore());
        }
    }
    /**
    ...
    {
        include \Whisk\Recipes\Vendor\Carbon_Fields\DIR . '/templates/Container/post_meta.php';
    }
    /**
