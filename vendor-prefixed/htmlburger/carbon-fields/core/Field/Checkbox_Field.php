 ...
 */
class Checkbox_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Field
{
    /**
     * @{inheritDoc}
     */
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('option_value' => $this->get_option_value(), 'option_label' => parent::get_label()));
        return $field_data;
    }
    /**
     * Get the field label.
