 ...
 */
abstract class Scripts_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Textarea_Field
{
    /**
    ...
    {
        $is_valid_datastore = $this->get_datastore() instanceof \Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Theme_Options_Datastore || $this->get_datastore() instanceof \Whisk\Recipes\Vendor\Carbon_Fields\Datastore\Network_Datastore;
     ...
     * @return string
     */
    protected abstract function get_default_help_text();
}
