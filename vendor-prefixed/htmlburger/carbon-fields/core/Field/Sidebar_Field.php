...
class Sidebar_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Select_Field
{
    /**
    ...
    {
        $sidebars = \Whisk\Recipes\Vendor\Carbon_Fields\Helper\Helper::get_active_sidebars();
        $options = array();
    ...
    public function to_json($load)
    {
        ...
        if ($this->enable_add_new) {
            $options[] = array('value' => '__add_new', 'label' => _x('Add New', 'sidebar', 'carbon-fields'));
        }
        ...
        $field_data = \array_merge($field_data, array('value' => $this->get_formatted_value()));
