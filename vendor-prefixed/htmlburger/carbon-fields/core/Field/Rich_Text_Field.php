 ...
 */
class Rich_Text_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Textarea_Field
{
    /**
     ...
     * @var array
     */
    protected $settings = array('media_buttons' => \true, 'tinymce' => array('resize' => \true, 'wp_autoresize_on' => \true));
    /**
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('rich_editing' => user_can_richedit() && !empty($this->settings['tinymce']), 'media_buttons' => $media_buttons, 'settings_reference' => $this->get_settings_reference()));
        return $field_data;
    }
}
