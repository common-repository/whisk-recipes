 ...
 */
class Select_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Predefined_Options_Field
{
    /**
     * {@inheritDoc}
     */
    public function set_value_from_input($input)
    {
        ...
        if (isset($input[$this->get_name()])) {
            ...
            $raw_value = \Whisk\Recipes\Vendor\Carbon_Fields\Helper\Helper::get_valid_options(array($raw_value), $options_values);
            if (!empty($raw_value)) {
                $value = $raw_value[0];
            }
        }
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('value' => \strval($value), 'options' => $options));
        return $field_data;
    }
    /**
     * {@inheritDoc}
