 ...
 */
class Color_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Field
{
    /**
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('value' => $this->get_value(), 'alphaEnabled' => $this->get_alpha_enabled(), 'palette' => $this->get_palette()));
        return $field_data;
    }
    /**
     * Get color presets
     ...
     * @return self    $this
     */
    public function set_alpha_enabled($enabled = \true)
    {
