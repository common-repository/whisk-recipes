 ...
 */
class Media_Gallery_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Field
{
    /**
     ...
     * @var boolean
     */
    protected $duplicates_allowed = \true;
    /**
     * Toggle the inline edit functionality
     *
     * @var boolean
     */
    protected $can_edit_inline = \true;
    /**
    ...
    protected function value_to_json()
    {
        ...
        return array('value' => \array_map('absint', $value_set));
    }
    /**
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, $this->value_to_json(), array('value_type' => $this->value_type, 'type_filter' => $this->file_type, 'can_edit_inline' => $this->can_edit_inline, 'duplicates_allowed' => $this->get_duplicates_allowed()));
        return $field_data;
    }
}
