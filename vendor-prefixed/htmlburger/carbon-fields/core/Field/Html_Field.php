 ...
 */
class Html_Field extends \Whisk\Recipes\Vendor\Carbon_Fields\Field\Field
{
    /**
    ...
    public function set_html($callback_or_html)
    {
        if (!\is_callable($callback_or_html) && !\is_string($callback_or_html)) {
            \Whisk\Recipes\Vendor\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Only strings and callbacks are allowed in the <code>set_html()</code> method.');
            return $this;
        }
