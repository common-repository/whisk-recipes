...
if (!\defined(__NAMESPACE__ . '\\VERSION')) {
    \define(__NAMESPACE__ . '\\VERSION', '3.2.1');
}
...
if (!\defined(__NAMESPACE__ . '\\URL')) {
    \define(__NAMESPACE__ . '\\URL', \Whisk\Recipes\Vendor\Carbon_Fields\Carbon_Fields::directory_to_url(\Whisk\Recipes\Vendor\Carbon_Fields\DIR));
}
