...
class CachingReflector implements \Whisk\Recipes\Vendor\Auryn\Reflector
{
    ...
    private $reflector;
    private $cache;
    public function __construct(\Whisk\Recipes\Vendor\Auryn\Reflector $reflector = null, \Whisk\Recipes\Vendor\Auryn\ReflectionCache $cache = null)
    {
        $this->reflector = $reflector ?: new \Whisk\Recipes\Vendor\Auryn\StandardReflector();
        $this->cache = $cache ?: new \Whisk\Recipes\Vendor\Auryn\ReflectionCacheArray();
    }
    ...
    public function getParamTypeHint(\ReflectionFunctionAbstract $function, \ReflectionParameter $param)
    {
        ...
        if ($function instanceof \ReflectionMethod) {
            ...
            $paramCacheKey = \strpos($lowFunc, '{closure}') === \false ? self::CACHE_KEY_FUNCS . ".{$lowFunc}.param-{$lowParam}" : null;
        }
