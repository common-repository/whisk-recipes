...
class Executable
{
    ...
    public function __invoke()
    {
        ...
        return $this->callableReflection->isClosure() ? $this->invokeClosureCompat($reflection, $args) : $reflection->invokeArgs($args);
    }
    /**
    ...
    private function invokeClosureCompat($reflection, $args)
    {
        if (\version_compare(\PHP_VERSION, '5.4.0') >= 0) {
            ...
            $closure = \Closure::bind($reflection->getClosure(), $reflection->getClosureThis(), $scope ? $scope->name : null);
