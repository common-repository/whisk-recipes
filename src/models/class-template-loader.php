...
class Template_Loader {
	 ...
	 * @var string
	 */
	protected $filter_prefix = 'whisk_recipes';
	 ...
	 * @var string
	 */
	protected $theme_template_directory = 'whisk-recipes';
	...
	protected function get_templates_dir() {
		return trailingslashit( Utils::get_plugin_path() ) . $this->plugin_template_directory;
	}
}
